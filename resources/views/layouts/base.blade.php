                                ...
                                @auth
                                    @if(Auth::user()->type === 'ADM')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="userlist" href="{{route('admin.userlist')}}">Management</a>
                                    ...
                                    @elseif(Auth::user()->type === 'EDIT')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                <li class="menu-item">
                                                    <a title="Dashoard" href="{{route('editor.dashboard')}}">Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a title="Categories" href="{{route('editor.categories')}}">Categories</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a title="Products" href="{{route('editor.products')}}">Products</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a title="Orders" href="{{route('editor.orders')}}">Orders</a>
                                                </li>
                                                <li class="menu-item"><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                                <form id="logout-form" method="POST" action="{{route('logout')}}">
                                                    @csrf
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                <li class="menu-item">
                                                    <a title="Dashoard" href="{{route('user.dashboard')}}">Dashboard</a>
                                                </li>
                                                <li class="menu-item"><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                                <form id="logout-form" method="POST" action="{{route('logout')}}">
                                                    @csrf
